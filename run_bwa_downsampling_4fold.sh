...
bwa mem $FASTA ${i} 2> $STEM/${STEM}_downsampling_4fold_bwa.err | samtools sort -o $STEM/${STEM}_downsampling_4fold_sorted.bam 2> $STEM/${STEM}_downsampling_4fold_samtools_sort.err;
done
