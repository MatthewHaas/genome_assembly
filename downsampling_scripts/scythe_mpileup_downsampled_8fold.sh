...
#PBS -e scythe_mpileup_8fold.err
#PBS -o scythe_mpileup_8fold.out
#PBS -N scythe_mpileup_8fold
...
export bams="downsampled_8fold_bam_list"
export prefix="200519_downsampled_8fold"
